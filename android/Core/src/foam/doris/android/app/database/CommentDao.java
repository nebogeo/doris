 ...
 **
 **/
package foam.doris.android.app.database;
...
import foam.doris.android.app.entities.Comment;
...
public class CommentDao extends DbContentProvider implements ICommentDao,
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#addComment(java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#addComment(com.ushahidi
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#fetchCheckinComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#fetchReportComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#updateCheckinByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#updateCheckinByCheckinId
	 * (int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see foam.doris.android.app.database.ICommentDao#deleteAllComment()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#deleteCommentByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.ICommentDao#deleteCommentByCheckinId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.DbContentProvider#cursorToEntity(android
	 * .database.Cursor)
	 */
