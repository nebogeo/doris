...
import foam.doris.android.app.entities.User;
...
public class UserDao extends DbContentProvider implements IUserSchema, IUserDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see foam.doris.android.app.database.IUserDao#fetchUsersById(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.IUserDao#addUser(foam.doris.android
	 * .app.entities.User)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see foam.doris.android.app.database.IUserDao#addUser(java.util.List)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see foam.doris.android.app.database.IUserDao#deleteAllUsers()
	 */
	@Override
