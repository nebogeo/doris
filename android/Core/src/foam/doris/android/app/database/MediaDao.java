...
public class MediaDao extends DbContentProvider implements IMediaDao,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see foam.doris.android.app.database.IMediaDao#deleteAllMedia()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see foam.doris.android.app.database.IMediaDao#addMedia(java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.doris.android.app.database.IMediaDao#addMedia(foam.doris.android
	 * .app.entities.Media)
	 */
	@Override
