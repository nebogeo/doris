...
import foam.doris.android.app.entities.OfflineReport;
...
public class OfflineReportDao extends DbContentProvider implements IOfflineReportDao,
     ...
     * (non-Javadoc)
     * @see
     * foam.doris.android.app.database.IOfflineReportDao#fetchAllOfflineIncidents
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * foam.doris.android.app.database.IOfflineReportDao#deleteAllOfflineReport
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * foam.doris.android.app.database.IOfflineReportDao#addOfflineReport(
     * foam.doris.android.app.entities.OfflineReport)
     */
    @Override
